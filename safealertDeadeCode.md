...
This is an instance of some code that isnt being used and is a work in progress so it isnt dead code. 

'setBlueThings' has been created but is still a work in progress

```{Java}
private void setBlueThings(){ //THIS IS TEMPORARY 
